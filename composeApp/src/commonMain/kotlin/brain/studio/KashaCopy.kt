...
aiConnectionOk|Подключение доступно|Connection available|Conexión disponible|Connexion disponible|Verbindung verfügbar|Підключення доступне|Падключэнне даступнае|Қосылым қолжетімді
...
aiDataProjectIds|служебные идентификаторы проектов|project identifiers|identificadores de proyectos|identifiants de projet|Projektkennungen|службові ідентифікатори проєктів|службовыя ідэнтыфікатары праектаў|жоба идентификаторлары
