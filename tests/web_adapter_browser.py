"""Browser-adapter regression: MediaRecorder, IndexedDB recovery and audio mutual exclusion."""
import json
import os
import shutil
import time
...
with sync_playwright() as pw:
    ...
    try:
        ...
        # Отказ getUserMedia не оставляет ложный pending и recorder возвращается в idle.
        ...
        # Реальная browser-сессия: pause/resume, сбой отправки, reload и recovery.
        ...
        blocked_record = page.evaluate('kashaPlatform.start()')
        assert blocked_record.startswith('ERROR:'), blocked_record
